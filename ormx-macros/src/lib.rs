...
/// `#[ormx(insertable)]`.  
/// This struct will contain all fields of the struct, except fields annotated with `#[ormx(default)]`,
/// since the value of these fields will be generated by the database.
///
/// If you're using an auto-incrementing integer as key, it needs to be marked with `#[ormx(default)]` as well.
///
